...
public abstract class RandomForestClassifier<T, K> implements IFeatureProbability<T, K> {
    ...
    public void reset() {
        this.featureCountPerCategory =
                new Hashtable<K, Dictionary<T,Integer>>(
                        RandomForestClassifier.INITIAL_CATEGORY_DICTIONARY_CAPACITY);
        this.totalFeatureCount =
                new Hashtable<T, Integer>(
                        RandomForestClassifier.INITIAL_FEATURE_DICTIONARY_CAPACITY);
     ...
     * probability.
     *
     * @see de.daslaboratorium.machinelearning.classifier.RandomForestClassifier#featureProbability(Object, Object)
     * @see de.daslaboratorium.machinelearning.classifier.RandomForestClassifier#featureWeighedAverage(Object, Object, IFeatureProbability, float, float)
     *
